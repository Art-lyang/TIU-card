...
var CARDS_HAEUN = [
  ...
  // 데이터 분석 역할 → 임재혁 겸임
  { id: "CS-010", act: [3,4], priority: "중", bg: "comms",
  ...
  // 프로메테우스 정보 분석 → 불완전
  { id: "CS-011", act: [3,4], priority: "중", bg: "comms",
  ...
  // ORACLE 이상 감지 → 놓침
  { id: "CS-012", act: [3,4], priority: "중", bg: "comms",
  ...
  // 강도윤 반응
  { id: "CS-013", act: [3,4], priority: "중", bg: "base",
  ...
  // 윤세진 반응
  { id: "CS-014", act: [3,4], priority: "중", bg: "lab",
  ...
  // 임재혁 반응
  { id: "CS-015", act: [3,4], priority: "중", bg: "comms",
