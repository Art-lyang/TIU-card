...
var ENDING_DEFS = {
  ...
  TIME_UP: {
    ...
    narrative: [
      ...
      "",
      "기록을 검토했습니다. 결정적인 분기점이 없습니다.",
      "당신은 어느 결말로도 기울지 않은 채 기간을 채웠습니다.",
      "",
      "ORACLE은 판정을 보류합니다.",
      "사례는 '미결'로 분류되어, 세션 데이터와 함께 관측 보관됩니다.",
      "",
      "당신이 남긴 궤적 — 그 모호함이 당신의 판결입니다.",
      "",
      "[세션 종료 — DISPATCH EXPIRED · CASE UNRESOLVED]"
    ]
  },
  F: {
    name: "[데이터 손상]",
