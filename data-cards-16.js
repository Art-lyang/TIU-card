// data-cards-16.js — Act 2~3 중반부 특별 이벤트 카드 (C-260 ~ C-270)
// Day 11~24 구간 반복감 해소: 이변체 접근, 프로메테우스 접선, 기지 위기, ORACLE 개입
// v1.1: Act 경계(5/13/24) 변경에 따라 act 배열을 [2,3] 또는 [2,3,4]로 확장
...
var CARDS_MIDGAME = [
  ...
  { id: "C-264", act: [2,3], priority: "상", bg: "base", tag: "midgame-crisis",
    cond: function(s,g,logs) { return (s.day >= 14 && s.day <= 22) && logs.indexOf('LOG-050')<0 },
  ...
  { id: "C-265", act: [2,3], priority: "상", bg: "weather", tag: "midgame-crisis",
  ...
  { id: "C-266", act: [2,3], priority: "상", bg: "oracle", tag: "midgame-oracle",
    cond: function(s,g,logs) { return (s.day >= 12 && s.day <= 23 && g <= 5) && logs.indexOf('LOG-050')<0 },
  ...
  { id: "C-268", act: [2,3], priority: "중", bg: "base", tag: "midgame-drama",
  ...
  { id: "C-269", act: [2,3,4], priority: "중", bg: "lab", tag: "midgame-drama",
  ...
  { id: "C-270", act: [2,3], priority: "중", bg: "base", tag: "midgame-drama",
    cond: function(s,g,logs) { return (s.day >= 16 && s.day <= 23) && logs.indexOf('LOG-050')<0 },
