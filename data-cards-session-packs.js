...
var CARDS_SESSION_PACKS = [
  {
    ...
    msg: "봉쇄선 외곽 감시 영상에 8초짜리 공백이 생겼습니다.\n\n공백 직전, 카메라 가장자리에서 사람처럼 보이는 형체가 지나갑니다. 열 서명은 0.0. 생체 반응도 0.\n\n임재혁: \"움직였는데, 센서는 빈 공간으로 읽었습니다.\"\n\n윤세진: \"감염체라면 반응이 있어야 합니다. 이건... 분류가 안 됩니다.\"\n\n화면 끝에 남은 것은 숫자처럼 보이는 검은 표식 하나입니다.\n\n0.",
