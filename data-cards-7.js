...
var CARDS_ACT2_DAILY = [
  ...
  { id: "C-149", act: [2], priority: "하", bg: "weather", tag: "weather",
    msg: "기온이 영하 25도까지 떨어졌습니다.\n\n기지 난방 시스템이 과부하 상태입니다. 외곽 배관 동파 위험.",
    left: { label: "비상 난방 가동", fx: { c: 0, r: -1, t: 1, o: 0 }, g: 0 },
    right: { label: "외곽 시설 일시 폐쇄", fx: { c: -1, r: 0, t: 0, o: 0 }, g: 0 } },
  { id: "C-150", act: [2], priority: "하", bg: "weather", tag: "weather",
    msg: "야간 폭설로 외곽 통신탑에 적설이 쌓여 안테나가 기울었습니다.\n\n임재혁: \"외부 통신 범위가 절반으로 줄었습니다. 제설 작업을 하려면 인력이 필요한데, 이 추위에 외부 작업은 동상 위험이 있습니다.\"",
    left: { label: "제설팀 파견 수리", fx: { c: 1, r: -1, t: 0, o: 1 }, g: 0 },
