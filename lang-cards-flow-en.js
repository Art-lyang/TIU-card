...
window.TS_I18N.mergeContent('en', {
  cards: {
    ...
    "A3-SUPPLY-03": { msg:"[ORACLE: Entering the branch-operations transition phase — HQ stabilization support package approved.]\n\nSeo Hae-eun checks the handover list.\n\"Supplies and personnel came down together. It's a signal not to collapse at the turn. That's what holding out earns.\"\n\nKang Do-yun: \"We've got room to breathe. We just have to decide where to spend it.\"", leftLabel:"Balance supplies and personnel", rightLabel:"Pour it where it's most urgent" },
