...
var newsA2Triage01 = "[내부] Act2 후반 단서, 결론 고정 없이 Act3 교차검증 목록으로 이관";
...
window.TS_I18N.mergeContent('en', {
  cards: {
    ...
    "A2-TRIAGE-01": {
      msg: "Late Act 2. The clues gathered on the evidence table point in different directions.\n\nSeo Hae-eun says, \"If we label the conclusion now, ORACLE's summary will swallow it. I will separate outside relay, internal records, and field anomalies, then pass them into an Act 3 cross-check list.\"\n\nSometimes delaying the answer is also a command decision.",
      leftLabel: "Move it to the Act 3 cross-check list",
  ...
  oracleLogs: {
    "LOG-A2-FORESHADOW-01": {
      title: "Act2 Outside Relay Trace",
    ...
    "LOG-A2-FORESHADOW-02": {
      ...
      content: "The evidence table began separating outside relay traces, deleted records, and field anomalies as a distinct pattern. Conclusions will be cross-checked after Act 3."
    },
    "LOG-A2-TRIAGE-01": {
      title: "Act2 Cross-Check List",
      content: "Late Act2 clues were not fixed into a conclusion. They were separated into outside relay, internal record, and field anomaly lines, then passed into the Act3 cross-check list."
    },
    "LOG-A4-DG-SUPPORT": {
      title: "DG Emergency Logistics Support",
      content: "During the Act4 crisis, DG provided unofficial logistics support. The immediate resource collapse was softened, but the future cost of influence remains."
    },
    "LOG-A4-MD-SUPPORT": {
    ...
    "LOG-A4-EVIDENCE-RELIEF": {
      ...
      content: "Cross-checked evidence table conclusions allowed the branch to adjust Act4 deployment order. Evidence did not remove the crisis, but it gave the team a repairable structure."
    },
    "LOG-A4-STAFF-REVIEW": {
      title: "Act4 Final Staff Assignment",
      content: "The Act4 resource pressure sheet and evidence-table clues were reviewed together to reassign final roles by person. Pressure was treated as an operational choice, not just a loss."
    }
  },
  newsItems: (function(){
    var items = {};
    ...
    items[newsA2Triage01] = { type: 'internal', text: "[INTERNAL] Late Act2 clues moved to an Act3 cross-check list without forcing a conclusion." };
    ...
    items[newsA4EvidenceRelief] = { type: 'internal', text: "[INTERNAL] Evidence-table cross-check adjusts Act4 deployment order — resource loss buffer recorded." };
    items[newsA4StaffReview] = { type: 'internal', text: "[INTERNAL] Act4 review meeting drafts final deployment using both resource pressure and investigation clues." };
    return items;
  })()
});
})();
