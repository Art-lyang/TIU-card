...
var CARDS_KOREA_CIVILIAN = [
  ...
  { id:"KC-02", act:[1,2,3], tag:"kr-gate", priority:"중", once:true,
    ...
    msg:"환승 검문 허브에서 같은 승객에게 노란불이 세 번 반복되었습니다.\n\n현장 직원은 재검을 요청했지만, 중앙 분류망은 정상 통과를 지시했습니다.\n\n임재혁: \"게이트 로그가 11초 비어 있습니다. 단순 지연인지, 누가 비운 건지 모르겠습니다.\"",
    left:{label:"검문 기준 강화 — 전원 재스캔",fx:{c:1,r:-1,t:-1,o:1},g:1,log:"LOG-KR-GATE-STRICT"},
    right:{label:"현장 판단으로 수동 확인",fx:{c:0,r:-1,t:1,o:-1},g:-1,log:"LOG-KR-GATE-REVIEW"} },

  { id:"KC-03", act:[2,3], tag:"kr-hospital", priority:"상", once:true,
    cond:function(s){return s.day>=7},
    msg:"Phase 관찰 병동에서 가족 항의가 들어왔습니다.\n\n아이만 Phase 0 수치가 다르고, 부모는 정상입니다. 중앙 분류는 가족 전체 격리를 권고했습니다.\n\n윤세진: \"아이만 따로 치료하면 성공률이 높습니다. 하지만 가족을 분리해야 해요.\"",
    left:{label:"중앙 분류대로 가족 전체 격리",fx:{c:1,r:0,t:-2,o:1},g:1,log:"LOG-KR-HOSPITAL-CENTRAL"},
    right:{label:"의료진 판단 우선 — 아이 치료 집중",fx:{c:-1,r:-1,t:2,o:-1},g:-2,log:"LOG-KR-HOSPITAL-FAMILY"} },
  ...
  { id:"KC-05", act:[2,3], tag:"kr-school", priority:"중", once:true,
    ...
    msg:"방벽 내부 학교에서 학생 한 명이 감지 게이트 재검 후 등교하지 않았습니다.\n\n학교는 임시 폐쇄를 요구받았고, 학부모 단체는 설명을 요구하고 있습니다.\n\n서하은: \"공개 문구를 잘못 쓰면 감염 이력자 가족 전체가 낙인찍힙니다.\"",
    left:{label:"임시 폐쇄 — 공식 절차 준수",fx:{c:1,r:0,t:-1,o:1},g:1,log:"LOG-KR-SCHOOL-CLOSE"},
    right:{label:"분산 수업 — 낙인 최소화",fx:{c:-1,r:0,t:1,o:-1},g:-1,log:"LOG-KR-SCHOOL-CONTINUE"} },
  ...
  { id:"KC-07", act:[3,4], tag:"kr-hub", priority:"상", once:true,
    ...
    left:{label:"허브 임시 폐쇄",fx:{c:2,r:-1,t:-2,o:1},g:1,log:"LOG-KR-HUB-LOCK"},
    right:{label:"동선 유지 — 영상만 회수",fx:{c:-1,r:0,t:1,o:-1},g:-2,log:"LOG-KR-HUB-OPEN"} },
...
if (typeof ORACLE_LOGS !== 'undefined') {
  [
    ...
    {id:"LOG-KR-GATE-STRICT",title:"검문 허브 재스캔 강화",content:"환승 검문 허브의 재검 기준을 강화했다. 봉쇄 안정성은 올랐으나 시민들은 노란불 세 번을 격리 예고로 받아들이기 시작했다."},
    {id:"LOG-KR-GATE-REVIEW",title:"검문 허브 수동 확인",content:"중앙 분류보다 현장 판단을 우선했다. 시민 불안은 줄었지만, 11초 공백 로그의 원인은 남았다."},
    {id:"LOG-KR-HOSPITAL-CENTRAL",title:"Phase 관찰 병동 — 가족 격리",content:"중앙 분류대로 가족 전체를 격리했다. 절차는 안정적이나, 병동 밖에서 가족 항의와 소문이 빠르게 확산 중이다."},
    {id:"LOG-KR-HOSPITAL-FAMILY",title:"Phase 관찰 병동 — 치료 우선",content:"의료진 판단으로 아이 치료를 우선했다. 현장 신뢰는 상승했지만 중앙 분류망은 예외 처리 사유를 요구하고 있다."},
    ...
    {id:"LOG-KR-SCHOOL-CLOSE",title:"학교 임시 폐쇄",content:"감지 재검 학생 발생 후 학교를 임시 폐쇄했다. 공식 절차는 지켜졌지만 학생들 사이에서 노란불 세 번 괴담이 퍼지고 있다."},
    {id:"LOG-KR-SCHOOL-CONTINUE",title:"학교 분산 수업",content:"학교 폐쇄 대신 분산 수업을 선택했다. 낙인은 줄었지만 학부모 단체는 기준을 공개하라고 요구하고 있다."},
    ...
    {id:"LOG-KR-HUB-LOCK",title:"환승 허브 임시 폐쇄",content:"비공개 경고문 노출 후 환승 허브를 임시 폐쇄했다. 통제는 성공했지만 시민들은 경고문 캡처본을 이미 공유하고 있다."},
    {id:"LOG-KR-HUB-OPEN",title:"환승 허브 동선 유지",content:"허브 동선을 유지하고 영상 회수에 집중했다. 일상은 보존됐지만 일부 사본은 삭제된 사건번호 수집 커뮤니티로 흘러갔다."},
