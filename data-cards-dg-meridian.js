...
// v1.4 추가: SUP-DG-WARN — DG 100% 편향 시 ORACLE 주의 경고 (보상 0)
//
// LOG 네트워크:
...
var CARDS_DG_MERIDIAN = [
  ...
  // ═══════════════════════════════════════════════════════════
  //  SUP-DG-WARN : DG 편향 보급 경고 (보상 없음)
  //  트리거: LOG-SUPPLY-DG 존재 + LOG-SUPPLY-MD 부재 (100% DG 편향)
  //  효과: 서사 고지만 — 스탯 변화 0
  // ═══════════════════════════════════════════════════════════
  { id: "SUP-DG-WARN", act: [3,4], priority: "상", bg: "comms", once: true,
    req: function(s,g,logs){ return s.day >= 17 && logs.indexOf('LOG-SUPPLY-DG') >= 0 && logs.indexOf('LOG-SUPPLY-MD') < 0; },
    msg: "ORACLE 정식 통신. 자동 합성음이지만, 필터 없이 직접 들어옵니다.\n\n[ORACLE → KR-INIT-001 지휘관 / 주의 요망]\n\n[사안: 대가 인더스트리 일방 보급 수령 패턴 감지.]\n\n[분석 메모: 대가 그룹의 일부 공급망이 — 프로메테우스 계열로 의심되는 법인과 간접 연결되어 있을 가능성이 관측됩니다. 확정 증거는 없습니다. 그러나 지휘관의 선택이 한쪽에 지나치게 쏠릴 경우, 본부는 추가 감사를 고려할 수 있습니다.]\n\n[권고: 보급 루트 다변화. 회신 불필요.]\n\n서하은: \"...ORACLE이 '추가 감사'라는 표현을 쓴 건 처음입니다.\"",
    left:  { label: "경고를 기록한다", fx: { c: 0, r: 0, t: 0, o: 0 }, g: 0 },
    right: { label: "증거 없다 — 무시한다", fx: { c: 0, r: 0, t: 0, o: 0 }, g: 0 } }
