...
var CARDS_RESOURCE = [
  ...
  { id: "C-101", act: [1,2,3], priority: "하", img: IMG.card_supply_regular,
  ...
  { id: "C-103", act: [2,3], priority: "하", req: function(s){ return s.day >= 5 },
