...
var MISSIONS = {
  "M-001": {
    ...
    nodes: {
      ...
      oracle: {
        text: "[ORACLE: 원격 분석 프로토콜 가동. 드론 전개 중.]\n\n드론이 오염 구역 상공을 저고도로 통과하며 스펙트럼 데이터를 수집한다.\n\n기존 정찰 데이터와 교차 분석이 가능하다. 직접 샘플은 없지만 ORACLE의 모델에는 충분한 데이터다.\n\n[ORACLE: 지휘관의 판단에 감사드립니다. 효율적인 선택입니다.]\n\n기지로 돌아옵니다. 윤세진이 ORACLE 분석 결과를 검토하고는 고개를 갸웃거립니다.\n\"데이터가 이상해요. 이 농도면 현장에서 직접 봐야 할 것들이 있는데...\"\n\"ORACLE이 정리한 데이터에서는 그 부분이 빠져 있어요.\"\n\nORACLE이 효율적이라고 한 선택에서, 무엇이 생략되었는지는 알 수 없습니다.",
        choices: [{ label: "[ 기지 귀환 ]", next: "end", result: { c: 1, r: 0, t: -1, o: 2 }, log: "LOG-M001-REMOTE" }]
      },
    }
  },
  "M-002": {
    ...
    nodes: {
      ...
      eliminate: {
        text: "강도윤이 무기를 준비한다.\n\n당신이 신호를 보낸다. SPEC-011은 살상 위협이다. 직접 제거 외에 다른 선택지는 없다.\n\n숲 안쪽으로 진입한다.\n\n목소리들이 계속 울린다. C-14 요원, 그리고 이름 모를 수많은 사람들의 목소리.\n\n그때 — 당신의 심장이 멈춘다.\n\n\"지휘관님. 접니다. 한동혁입니다.\"\n\n당신의 부하였다. 3년 전 강원도 동부 작전에서 실종된, 당신의 병사.\n\n강도윤이 당신의 표정을 본다. 뭔가를 눈치챈다. 하지만 묻지 않는다.\n\n총구를 향한다.\n\n비명. 그러나 SPEC-011의 비명인지, 가짜 목소리의 비명인지 구분할 수 없다.\n\n숲이 조용해진다.\n\n돌아가는 길. 당신은 아무 말도 하지 않는다.\n\n강도윤이 조심스럽게 묻습니다.\n\"...아는 목소리가 있었습니까?\"\n\n잠깐 침묵.\n\n\"목소리가 남아있었다는 건... 3년 동안 그 안에 있었다는 뜻입니까?\"\n\n대답할 수 없습니다. 숲은 이제 완전히 조용합니다.",
  ...
  "M-003": {
    ...
    nodes: {
      ...
      mountain: {
        ...
        choices: [{ label: "[ 기지 귀환 — 증거물 확보 ]", next: "end", result: { c: 0, r: -1, t: 1, o: -1 }, log: ["LOG-008","LOG-M003-COORD"] }]
      },
      village: {
      ...
      oracle_path: {
        ...
        choices: [{ label: "[ 기지 귀환 — ORACLE에 위임 ]", next: "end", result: { c: 1, r: 0, t: -1, o: 2 }, log: ["LOG-008","LOG-M003-COORD"] }]
      },
      record: {
