...
var CARDS_PROLOGUE = [
  ...
  { id: "CA-014", act: [1], priority: "하", bg: "comms", once: true,
    req: function(s){ return s.day >= 2 },
  ...
  { id: "CA-015", act: [1], priority: "하", bg: "comms", once: true,
    req: function(s){ return s.day >= 2 },
  ...
  { id: "CA-016", act: [1], priority: "중", bg: "base", once: true,
  ...
  { id: "CA-017", act: [1], priority: "중", bg: "base", once: true,
    req: function(s){ return s.day >= 3 },
  ...
  { id: "CA-018", act: [1], priority: "상", bg: "comms", once: true,
