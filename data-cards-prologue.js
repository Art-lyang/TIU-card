// data-cards-prologue.js — 새 Act 1 (Part 1: CA-001~CA-018 핵심 카드)
// 컨셉: 기지 소개 + 일상 운영 + ORACLE 유능함 → 미세 이상 징후
// 주의: 임재혁 조사 테이블 없음. introOk 필터 고려해 초반 카드는 직책 표기 우선.
// Part 2(CA-019~CA-033 보충 풀)는 data-cards-prologue-2.js 참조
...
var CARDS_PROLOGUE = [
  ...
  { id: "CA-014", act: [1,2], priority: "하", bg: "comms", once: true, glitch: 1,
  ...
  { id: "CA-015", act: [1,2], priority: "하", bg: "comms", once: true, glitch: 1,
    req: function(s){ return s.day >= 5 },
  ...
  { id: "CA-016", act: [1,2], priority: "중", bg: "base", once: true, glitch: 1,
  ...
  { id: "CA-017", act: [1,2], priority: "중", bg: "base", once: true, glitch: 1,
    req: function(s){ return s.day >= 6 },
