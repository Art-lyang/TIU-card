...
var _ER_MISSING = {
  ...
  'haeun_3_15-21': {
    a: { label: '그 차이, 계속 파봐.', trust: 2, reply: '네, 표본 늘려서 검증하겠습니다.' },
    b: { label: '증거 확보부터.', trust: 0, reply: '네, 신중하게 모으겠습니다.' }
  },
  'haeun_3_22-28': {
    a: { label: '누가 그러는지 찾아내자.', trust: 2, reply: '네. 접근 로그부터 추적하겠습니다.' },
  ...
  // ═══ 윤세진 (sejin) ═══
  'sejin_2_5-7': {
    a: { label: '편차 원인까지 분석해.', trust: 2, reply: '네, 관찰 반복해서 확인하겠습니다.' },
  ...
  'sejin_3_15-21': {
    a: { label: '그 체계 밝혀내.', trust: 2, reply: '네, 관찰 프로토콜 정리하겠습니다.' },
  ...
  'jaehyuk_2_8-10': {
    a: { label: '나도 같은 생각이다.', trust: 2, reply: '...기록해 두겠습니다. 지휘관님도 주시해주십시오.' },
  ...
  'weber_3_25-35': {
    a: { label: '끝까지 진실을 찾겠다.', trust: 2, reply: '그 말을 기다렸습니다, 지휘관. 함께 가 봅시다.' },
    b: { label: '개인적 평가는 사양한다.', trust: 0, reply: '...그것도 당신다운 답이군요. 존중합니다.' }
  },
  'weber_3_36-99': {
    a: { label: '한국을 이용하는 건 허락 못 한다.', trust: 2, reply: '...인정합니다. 그 선은 당신이 그어 주십시오.' },
    b: { label: '데이터 손실이 아니라 사람의 죽음이다.', trust: 2, reply: '맞습니다. 그 인식을 잊지 않겠습니다.' }
  },

  // ═══ 닉 포스터 (foster) — 프로메테우스 요원 ═══
  'foster_3_27-35': {
    a: { label: '쓸데없었다고 인정한 건 크다.', trust: 2, reply: '...그 말 한마디가, 오늘은 좀 무거웠어요.' },
    b: { label: '후회 없다는 말은 기억해두지.', trust: -1, reply: '...그러세요. 그게 당신 방식이니까.' }
  },
  'foster_3_36-99': {
    a: { label: '성공 사례라는 게 제일 위험한 거다.', trust: 2, reply: '정확해요. 그래서 당신이 버텨야 합니다.' },
    b: { label: '필라델피아·소바리 자료 넘겨.', trust: 1, reply: '...오늘 밤 채널로 보내드리죠.' }
  },

  // ═══ 박소영 (soyoung) — 분석관 (정체 은닉 중) ═══
  'soyoung_3_28-35': {
    a: { label: '서하은 방법론 잘 이어받아봐.', trust: 2, reply: '...네. 선배 스타일, 제대로 따라가 보겠습니다.' },
    b: { label: '여기 사람들도 너를 믿는다.', trust: 2, reply: '...그 말, 오래 기억할 것 같습니다.' }
  },
  'soyoung_3_36-99': {
    a: { label: '선별적 지연 패턴 즉시 공유해.', trust: 2, reply: '네. 오늘 밤 안에 전체 로그 정리해서 올리겠습니다.' },
    b: { label: '확증 나오면 그때 움직이자.', trust: 0, reply: '...알겠습니다. 조금 더 모아보겠습니다.' }
  },
