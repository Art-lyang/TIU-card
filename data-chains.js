...
var CHAINS = {
  ...
  "CH-005": {
    ...
    cards: [
      { id: "CH-005-1", priority: "상", msg: "지정된 좌표에 도착했습니다. 기지 북측 2km.\n\n어둠 속에서 한 남자가 서 있습니다. 수트. 정자세.\n\n마르쿠스 베버.\n\n\"시간을 내주셔서 감사합니다, 지휘관.\"\n\"단도직입적으로 말하겠습니다.\"\n\"ORACLE은 한국을 보호하고 있지 않습니다. 이용하고 있습니다.\"", left: { label: "증거를 보여라", fx: { c: 0, r: 0, t: 0, o: -2 }, g: -4 }, right: { label: "왜 내가 당신을 믿어야 하나?", fx: { c: 0, r: 0, t: 0, o: -1 }, g: -2 } },
      { id: "CH-005-2", priority: "상", msg: "베버가 태블릿을 건넵니다.\n\n화면에는 ORACLE의 내부 통신 기록이 있습니다.\n\n한국 해안 방벽 기술 데이터가 ORACLE 본부로 전송된 기록.\n한국 군사 네트워크 접속 로그.\n그리고 — 서하은의 전출 명령 원본. 발신자: ORACLE 자동 시스템.\n\n\"당신의 부지휘관은 너무 많은 것을 알아냈습니다.\"", left: { label: "데이터를 복사한다", fx: { c: 0, r: 0, t: 1, o: -3 }, g: -6 }, right: { label: "이것만으로는 부족하다", fx: { c: 0, r: 0, t: 0, o: -1 }, g: -2 } },
      { id: "CH-005-3", priority: "상", msg: "베버가 마지막으로 말합니다.\n\n\"우리는 한국의 해안 방벽을 함께 지켜왔습니다. 비공식적으로.\"\n\n\"ORACLE이 알려주지 않는 것 — 한국 봉쇄 성공률의 '미분류 외부 요인 31%'. 그게 우리입니다.\"\n\n\"다음에 연락하겠습니다. 이중철 지휘관.\"\n\n그가 어둠 속으로 사라집니다.", left: { label: "기지로 돌아간다", fx: { c: 0, r: 0, t: 1, o: -2 }, g: -5 }, right: { label: "강도윤에게만 알린다", fx: { c: 0, r: 0, t: 1, o: -1 }, g: -3, trust: 10 } },
    ]
  },
  "CH-006": {
