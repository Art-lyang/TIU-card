...
### 데이터
- `data-core.js` — NP, REWARDS, DIALOGUES(12종), ORACLE_LOGS(19종), BOOT_LINES
...
## 인물
**한국 지부**: 이중철(지휘관), 서하은(부지휘관/정보), 강도윤(현장), 윤세진(의료), 임재혁(기술)
...
| Act | 서사 | 일수 | 하루 카드 | 감쇠 |
|-----|------|------|----------|------|
| **Act 1: 프롤로그** | 배치 전 오리엔테이션, ORACLE 첫 접속 | 2~3일 | 3장 | 없음 |
| **Act 2: 부임** | 지부 세팅, 이변체 첫 조우 | Day 1~10 | 5장 | 없음 |
| **Act 3: 충돌** | 프로메테우스 대면, 서하은 분기 시작 | Day 11~25 | 6장 | c-1, r-1 |
| **Act 4: 선택** | GI 기반 분기, 엔딩 수렴 | Day 26+ | 7장 | c-2, r-2, t-1 |

## 메카닉
- 하루: Act별 카드 3/5/6/7장 → 이브닝 챗 → 뉴스 → 보상 → 다음 날
...
9. **유니버스 페이지** (TIU-WORLDBUILDING-SUMMARY.md 기반 HTML)
10. **이변체 추가** (현재 5종 → 목표 8~10종)
11. **현장 미션 확장** (현재 8개 → 목표 20~25개)
12. **3회차 유도지수 UI 노출**
13. **4회차+ OBSERVER ACCESS 잔향**
