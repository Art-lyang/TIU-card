...
EVENING_CHATS.push(
  ...
  { char: '서하은', act: [4], dayMin: 24, dayMax: 27,
    lines: [
  ...
  { char: '서하은', act: [4], dayMin: 28, dayMax: 31,
    lines: [
  ...
  { char: '서하은', act: [4], dayMin: 32, dayMax: 35,
    lines: [
...
EVENING_CHATS.push(
  ...
  { char: '임재혁', act: [4], dayMin: 24, dayMax: 26,
    lines: [
  ...
  { char: '임재혁', act: [4], dayMin: 27, dayMax: 29,
    lines: [
  ...
  { char: '임재혁', act: [4], dayMin: 30, dayMax: 31,
    lines: [
      "지휘관님, 문득 생각났는데요.",
  ...
  { char: '임재혁', act: [4], dayMin: 32, dayMax: 33,
    lines: [
  ...
  { char: '임재혁', act: [4], dayMin: 34, dayMax: 35,
    lines: [
