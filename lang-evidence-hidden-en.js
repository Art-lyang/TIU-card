...
window.TS_I18N.mergeContent('en', {
  evidence: {
    ...
    "EV-26": { name: "Yoon Se-jin parameter comparison", desc: "Repeated deviation between official EV-Sigma values and field analysis." },
  ...
  evidenceCombos: {
    ...
    "CMB-HS-02": { name: "Identity of the observer", result: "The OBSERVER session, the external ORACLE process, and the observation layer ORACLE cannot see are operated by the same presence. ORACLE is being used as a tool to watch us." },
