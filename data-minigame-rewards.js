(function(){
  ...
  var narratives = {
    ...
    "MI-01": {
      shield: {
        great: {
          textSuffix: "[봉인 시퀀스: 대성공]\n차단 순서가 완벽하게 맞아떨어진다.\n잔류 진동도 빠르게 가라앉고, 임재혁은 이번엔 제대로 막았다고 짧게 중얼거린다.",
  ...
  if (typeof ORACLE_LOGS !== "undefined") {
    ORACLE_LOGS.push(
      ...
      {
        id: "LOG-MG-DLG-SEJIN-SIGNAL",
        title: "윤세진 신호 정렬 후속 메모",
        content: "[현장 분석 후속 기록]\n\nShell Talker 음성층 분리 후 윤세진이 작성한 후속 메모.\n실제 희생자 발성 잔향과 유인 신호의 기준점이 구분되었고, 이후 구조 요청 필터링 기준을 현장 데이터로 보강할 수 있다."
      },
      {
        id: "LOG-MG-DLG-JAEHYUK-SEAL",
        title: "임재혁 봉인 절차 후속 메모",
        content: "[현장 분석 후속 기록]\n\nB2 하부 봉인 패널 분석 후 임재혁이 남긴 후속 메모.\n자동 루틴이 보조 잠금 절차를 건너뛴 정황이 확인되었으며, 봉인 설계 자체의 의도적 축약 가능성이 기록되었다."
      },
      {
        id: "LOG-MG-DLG-HAEUN-TRACE",
        title: "서하은 권한 추적 후속 메모",
        content: "[현장 분석 후속 기록]\n\n보안구역 인증 오류 추적 후 서하은이 정리한 후속 메모.\n삭제가 아니라 정상 패턴 아래에 흔적을 얇게 덮는 은폐 방식이 확인되었고, 유사한 접근 경로를 우선 탐색 대상으로 지정했다."
      }
    );
  }
