...
var CARDS_INVESTIGATE = [
  ...
  // ═══ 이변체 미조우 ACT 3 진입 카드 (1회성) ═══
  // ACT 2까지 이변체를 한 번도 만나지 않고 ACT 3에 돌입한 경우 트리거

  { id: "C-177", act: [3,4], priority: "상", bg: "forest",
  ...
  { id: "C-178", act: [3,4], priority: "상", bg: "lab",
    req: function(s,g,logs){
      return logs.includes("LOG-060") && !logs.includes("LOG-061") },
    msg: "윤세진이 야간 습격 잔해를 분석했습니다.\n\n\"두 종류의 시그니처가 확인됩니다.\"\n\"하나는 음파 기반 — 인간 음성을 모방합니다.\"\n\"다른 하나는 점액질 — 유기물 용해 능력 보유.\"\n\n\"어느 쪽을 먼저 추적하시겠습니까?\"",
    left: { label: "음파 개체 추적 (Shell Talker)", fx: { c: 1, r: -1, t: 0, o: -1 }, g: -1 },
    right: { label: "점액질 개체 추적 (Blood Pit)", fx: { c: -1, r: -1, t: 1, o: 0 }, g: 0 } },
  ...
  { id: "C-272", act: [3,4], priority: "상", tag: "spec-004",
    req: function(s,g,logs){ return logs.includes("LOG-025") && !logs.includes("LOG-026") },
  ...
  // 첫 조우 — 도시 하수구 정찰 보고
  { id: "C-273", act: [2,3], priority: "상", tag: "spec-015", bg: "forest",
  ...
  { id: "CT-303", act: [2,3], priority: "상", alert: true, bg: "forest", once: true, cctv: "card_breach_horde_cctv",
  ...
  { id: "CT-304", act: [2,3], priority: "상", alert: true, bg: "forest", once: true, cctv: "card_mannequin_sighting_cctv",
