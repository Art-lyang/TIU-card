...
window.TS_I18N.mergeContent('en', {
  cards: {
    ...
    "CE-013": { msg: "Encrypted external transmission received. Sender: unknown. Content: 'If you want to know ORACLE's true directive, respond.' Prometheus-family encryption.", leftLabel: "Respond", rightLabel: "Delete the reception record" },
