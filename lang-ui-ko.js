...
window.TS_I18N.mergeUI('ko', {
  ...
  gameOver:{
    ...
    skipEnding:'SKIP ▸', replayEnding:'⤢ 다시 재생',
  ...
  statusTags:{
    ...
    character:{
      ...
      special:{
        ...
        jaehyukDefect:'ORACLE 동조', sejinDead:'바이탈 OFF', sejinResearch:'연구 진행', sejinAnalysis:'분석 중', sejinLight:'약점 규명', jaehyeokJoint:'합동 연구',
