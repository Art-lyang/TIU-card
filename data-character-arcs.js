...
var CARDS_CHARACTER_ARCS = [
  { id:'C-320', act:[2], priority:'상', bg:'base', img:'char_haeun_tense', once:true,
  ...
  { id:'C-321', act:[2], priority:'상', bg:'forest', img:'char_doyun', once:true,
  ...
  { id:'C-322', act:[2,3], priority:'상', bg:'lab', img:'char_sejin', once:true,
  ...
  { id:'C-323', act:[2,3], priority:'상', bg:'comms', img:'char_jaehyuk', once:true,
