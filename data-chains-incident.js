...
var CARDS_INCIDENT = [
  ...
  { id: "C-301", act: [2,3], priority: "상", bg: "lab",
    cond: function(s,g,logs){ return s.day>=10 && logs.indexOf('LOG-INC-01')<0 },
  ...
  { id: "C-302", act: [1,2,3], priority: "중", bg: "base",
    cond: function(s,g,logs){ return s.day>=7 && logs.indexOf('LOG-INC-02')<0 },
  ...
  { id: "C-303", act: [2,3], priority: "상", bg: "lab",
    cond: function(s,g,logs){ return s.day>=14 && logs.indexOf('LOG-INC-03')<0 },
  ...
  { id: "C-304", act: [2,3], priority: "중", bg: "restricted",
    cond: function(s,g,logs){ return s.day>=12 && logs.indexOf('LOG-INC-04')<0 },
  ...
  // ── 직원 실종 (휴게실 → 비상 계단) ──
  { id: "C-305", act: [2,3], priority: "상", bg: "base",
    cond: function(s,g,logs){ return s.day>=16 && logs.indexOf('LOG-INC-05')<0 },
    msg: "아침 점호. 인원 1명 미확인.\n\n보급 담당 이수현 병장. 어젯밤 22:00 휴게실 퇴실 기록 이후 동선 없음.\n\n강도윤: \"숙소에 없습니다. 침구가 펼쳐진 상태인데, 사용 흔적이 없어요.\"\n\n기지 내 수색이 필요합니다.",
    hint: "▸ 조사를 시작하면 후속 카드가 이어집니다",
