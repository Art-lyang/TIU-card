...
function App(){
  ...
  var renderTrustToast=function(){
    ...
    return h('div',{style:{position:'fixed',bottom:100,left:'50%',transform:'translateX(-50%)',
      ...
      textAlign:'center',boxShadow:'0 0 12px '+(tt.delta>0?'rgba(157,255,116,.2)':'rgba(255,102,68,.2)')}},
      tt.char+' '+tt.arrow+(tt.delta>0?'+':'')+tt.delta)};
