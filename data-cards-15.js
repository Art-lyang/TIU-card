...
var CARDS_EXTERNAL = [
  ...
  { id: "C-248", act: [3], priority: "상", bg: "forest",
    cond: function(s,g,logs){ return s.day>=23 && logs.indexOf('LOG-016')>=0 && logs.indexOf('LOG-080')>=0 && logs.indexOf('LOG-081')<0 },
  ...
  { id: "C-253", act: [3], priority: "상", bg: "forest",
    cond: function(s,g,logs){ return logs.indexOf('LOG-082')>=0 && logs.indexOf('LOG-081')>=0 && logs.indexOf('LOG-083')<0 && s.day>=28 },
  ...
  { id: "C-256", act: [2], priority: "하", bg: "restricted",
    cond: function(s,g,logs){ return s.day>=9 },
  ...
  { id: "C-258", act: [3], priority: "중", bg: "comms",
    cond: function(s,g,logs){ return s.day>=22 },
  ...
  { id: "C-259", act: [3], priority: "중", bg: "comms",
  ...
  { id: "C-260", act: [3], priority: "하", bg: "base",
    cond: function(s,g,logs){ return s.day>=31 },
