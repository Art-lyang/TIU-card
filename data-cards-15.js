...
var CARDS_EXTERNAL = [
  ...
  { id: "C-248", act: [4], priority: "상", bg: "forest",
  ...
  { id: "C-249", act: [4], priority: "상", bg: "forest",
  ...
  { id: "C-250", act: [4], priority: "상", bg: "comms",
  ...
  // Act 1: 미세한 이상 징후
  { id: "C-254", act: [2], priority: "하", bg: "forest",
  ...
  { id: "C-255", act: [2], priority: "하", bg: "comms",
  ...
  // Act 3: 존재감이 짙어짐
  { id: "C-258", act: [4], priority: "중", bg: "comms",
