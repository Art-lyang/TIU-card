...
window.TS_I18N.mergeContent('en', {
  cards: {
    ...
    "CR-002": { msg: "Medical bay emergency report: only three days of medicine remain.\n\nYoon Se-jin: \"If anyone is injured, we will have no way to treat them.\"\n\nProcuring more from outside could be dangerous, depending on what the supply routes look like.", leftLabel: "Risk external procurement", rightLabel: "Optimize current stock allocation" },
