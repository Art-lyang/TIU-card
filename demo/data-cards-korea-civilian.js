...
var CARDS_KOREA_CIVILIAN = [
  ...
  { id:"KC-03", act:[2,3], tag:"kr-hospital", priority:"상", once:true,
    cond:function(s){return s.day>=10},
    msg:"Phase 관찰 병동에서 가족 항의가 들어왔다는 공유 보고가 올라왔습니다.\n\n아이만 Phase 0 — 감염 초기, 아직 되돌릴 수 있는 단계 — 수치가 다르고, 부모는 정상입니다. 중앙 분류망은 가족 전체 격리를 권고했고, 병원은 지부에 위험 평가 자료를 요청했습니다.\n\n윤세진: \"우리가 격리 결정을 내릴 수는 없어요. 대신 아이 치료 우선 근거와 가족 분리 위험을 같이 써줄 수 있습니다.\"",
  ...
  { id:"KC-04", act:[3], tag:"kr-market", priority:"중", once:true,
  ...
  { id:"KC-05", act:[3], tag:"kr-school", priority:"중", once:true,
    cond:function(s,g,logs){return (s.day>=16) && logs.indexOf('LOG-050')<0},
  ...
  { id:"KC-08", act:[3,4], tag:"kr-registry", priority:"중", once:true,
    cond:function(s,g,logs){return (s.day>=20) && logs.indexOf('LOG-050')<0},
