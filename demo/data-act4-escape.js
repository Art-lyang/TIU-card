...
if(typeof ENDING_DEFS!=='undefined'){
  ENDING_DEFS.E = { name:"탈출",
    narrative:[
      ...
      "베버는 그녀를 '미확인 관찰자'라고만 소개했다.",
      "\"이 작전 내내 당신을 관측해왔습니다. 지금껏 신원을 드리지 못했습니다.\"",
      "",
      "그녀 옆에는 닉 포스터. 그는 고개를 짧게 숙였다. 사과는 아니었다.",
      "하지만 표정에서 무언가가 풀려 있었다.",
      "",
      "\"ORACLE이 당신의 부재를 감지하는 데 약 6시간이 걸릴 겁니다.\" 관찰자가 말했다.",
  ...
  ENDING_DEFS.E_bad = { name:"LOST IN TRANSIT",
    narrative:[
      ...
      "\"지휘관님. 접니다. 박상훈입니다.\"",
      "",
      "박상훈 중위. 당신의 전임 부대에서 실종 처리된 장교.",
      "한동혁 일병에 이어 박상훈 중위까지 — 그 개체는 강원도 동부에서 잃은 당신의 옛 부대를 하나씩 삼켜 목소리를 거둬 왔다.",
      "당신은 그것을 알고 있었다.",
      "",
      "망설임. 0.4초.",
      "",
  ...
  CHAINS["CH-007"] = {
    ...
    cards:[
      ...
      { id:"CH-007-4", priority:"상",
        msg:"작전 개시 시각. 03:47.\n\n동행자들이 각자의 위치에 있습니다.\n교신 인증어는 '남십자'. 인증어 없는 목소리에는 응답하지 않는다 — 전원이 약속했습니다.\n당신은 호흡을 고릅니다.\n\n발소리. 숨소리. 그리고 그 너머의 침묵.\n\n이제, 나아갈 시간입니다.",
