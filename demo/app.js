...
function App(){
  ...
  return withOracleLink(h('div',{className:'screen'},
    ...
    orov&&orovEl(),
    daycut&&typeof DayCutOverlay!=='undefined'&&h(DayCutOverlay,{day:daycut,stats:stats,logs:getLiveLogs(logs),onSkip:function(){if(daycutTimerRef.current)clearTimeout(daycutTimerRef.current);setDaycut(null)}}),
