...
function App(){
  ...
  return withOracleLink(h('div',{className:'screen'},
    ...
    orov&&h('div',{className:'oracle-ov'+(fxMode==='reduced'?' oracle-ov--reduced':''),'aria-hidden':true},h('div',{className:'oracle-ov-box'},h('div',{className:'oracle-ov-t'},'[ORACLE OVERRIDE]'),h('div',{className:'oracle-ov-m'},orov))),
