...
(function(){
  ...
  SettingsPanel = function(p){
    ...
    return h('div',{style:{position:'fixed',inset:0,background:'rgba(0,0,0,0.85)',zIndex:300,display:'flex',alignItems:'center',justifyContent:'center',padding:14,boxSizing:'border-box'},onClick:function(e){if(e.target===e.currentTarget)closePanel()}},
      h('div',{style:{width:'100%',maxWidth:400,maxHeight:'80vh',position:'relative',background:'linear-gradient(180deg,rgba(12,18,23,.98),rgba(3,7,8,.99))',border:'1px solid rgba(var(--ui-rgb),0.28)',borderRadius:'var(--r-lg)',padding:'18px 20px',display:'flex',flexDirection:'column',overflow:'hidden',boxShadow:'0 18px 50px rgba(0,0,0,0.6),inset 0 1px 0 rgba(var(--ui-rgb),0.06)'}},h('div',{style:{position:'absolute',left:9,top:9,width:14,height:14,borderLeft:'1px solid rgba(var(--ui-rgb),0.4)',borderTop:'1px solid rgba(var(--ui-rgb),0.4)',pointerEvents:'none'}}),h('div',{style:{position:'absolute',right:9,bottom:9,width:14,height:14,borderRight:'1px solid rgba(var(--ui-rgb),0.4)',borderBottom:'1px solid rgba(var(--ui-rgb),0.4)',pointerEvents:'none'}}),
        h('div',{style:{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:12,paddingBottom:8,borderBottom:'1px solid rgba(var(--ui-rgb),0.15)'}},
          ...
          h('div',{style:{display:'flex',gap:6}},
            p.onMainMenu&&h('button',{style:{background:'linear-gradient(180deg,rgba(var(--ui-rgb),0.1),rgba(var(--ui-rgb),0.02))',border:'1px solid rgba(var(--ui-rgb),0.35)',borderRadius:'var(--r-sm)',color:'rgba(var(--ui-rgb),0.85)',fontFamily:"'Share Tech Mono',monospace",fontSize:10,padding:'4px 9px',cursor:'pointer'},onClick:function(){closePanel(p.onMainMenu)}},tr('settings.mainMenu','MENU')),
            h('button',{style:{background:'linear-gradient(180deg,rgba(var(--ui-rgb),0.1),rgba(var(--ui-rgb),0.02))',border:'1px solid rgba(var(--ui-rgb),0.35)',borderRadius:'var(--r-sm)',color:'rgba(var(--ui-rgb),0.85)',fontFamily:"'Share Tech Mono',monospace",fontSize:10,padding:'4px 9px',cursor:'pointer'},onClick:function(){closePanel()}},tr('settings.close','ESC')))),
