...
EVENING_CHATS.push(
  { char: '윤세진', act: [2,3], dayMin: 11, dayMax: 99,
    ...
    lines: function(p){
      ...
      if(repeat) return [
        "지휘관님. 제가 요즘 붙들고 있는 연구들, 지휘 단말에서 같이 보실 수 있게 다시 공유해 뒀어요.",
        "억제제, 표본 분석, 광반응 — 자원을 실어주시면 매일 단계별로 진행됩니다.",
        "이상하죠. 분명 처음 공유하는 건데... 어디서 본 것 같은 진행 흔적이 캐시에 남아 있어요.",
        "어쨌든 어떤 걸 우선할지, 지휘관님이랑 같이 보면서 정하고 싶어요."
      ];
      return [
        "지휘관님. 제가 요즘 뭘 붙들고 있는지... 한 번 보여드리고 싶어서요.",
        "그동안 혼자 정리하던 연구들을 지휘 단말에서 같이 보실 수 있게 공유해 뒀어요.",
        "EV-Σ 억제제, 이변체 표본 분석, 광반응 약점 — 제가 진행 중이거나 손대고 싶은 것들이에요.",
        "지휘관님이 자원을 실어주시면 단계별로 진행되고, 매일 조금씩 결과가 나옵니다.",
        "...어떤 연구에 힘을 실을지, 같이 봐 주시면 좋겠어요."
      ];
    } }
);
...
EVENING_RESPONSES['sejin_research_open'] = {
  a: { label: "좋아. 뭘 연구하는지 같이 보자", trust: 3,
       reply: "감사합니다. 그럼 첫 연구는 지휘관님이 골라 주세요. 같이 보면서 갈게요.",
       log: "LOG-RES-OPEN" },
  b: { label: "자원은 한정적이다. 신중히 고르자", trust: 1,
       reply: "알겠습니다. 그래도 봐 주셔서 다행이에요. 우선순위 높은 것부터 정리해 둘게요.",
       log: "LOG-RES-OPEN" }
};
...
EVENING_CHATS.push(
  { char: '임재혁', act: [2], dayMin: 8, dayMax: 12,
    ...
    lines: [
      "지휘관님, 개인적인 얘긴데요 — 저 학부 때 열려 있는 서버 구조 들여다보는 걸 좋아했습니다.",
      "그때 본 이상한 아키텍처가 하나 있었는데, ORACLE 로그 결이랑 가끔 겹쳐요.",
      "착각이면 좋겠습니다. 그래서 아직은 종이에만 남기고 있습니다."
    ] },
  ...
  { char: '임재혁', act: [4], dayMin: 29, dayMax: 30,
    ...
    lines: [
      ...
      "가끔 전화해서 '거긴 안 위험하냐'고만 물으세요. 제가 뭘 하는지는 모르시고요.",
      "사실대로는 말 못 하죠. 그냥 '괜찮다, 일이 재밌다'고만 합니다.",
      "...그 사람들 모르게 지키는 거니까. 이건 끝까지 가야 맞습니다."
    ] },
  ...
  { char: '임재혁', act: [4], dayMin: 34, dayMax: 34,
    ...
    lines: [
      "ORACLE 최종 세션 카운트가 지금까지 중 제일 높습니다.",
      "이번 운영, 기록상으로도 의미가 큽니다. 과장 아니고요.",
      "저는 그 옆에서 로그 찍는 역할이지만 — 끝까지 찍겠습니다.",
      "...남는 건 데이터고, 그건 거짓말 안 하니까요. 이상."
    ] },
  { char: '임재혁', act: [4], dayMin: 35, dayMax: 35,
    ...
    lines: [
      ...
      "지금 보니까 — 그 말이 맞았습니다.",
      "지휘관님이 어떻게 판단하시는지가, ORACLE을 규정합니다."
    ] }
);
