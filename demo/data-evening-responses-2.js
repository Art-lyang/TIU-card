...
var _ER_MISSING = {
  // ═══ 임재혁 간부 상실 붕괴 (ij) ═══
  'ij_break_1': {
    a: { label: 'ORACLE 권고가 늘 옳은 건 아니다', trust: -1, reply: '…압니다. 아는데, 그 권고를 따랐으면 지금 여기 있었을까 하는 생각이 자꾸 듭니다.' },
    b: { label: '네 잘못이 아니다', trust: 1, reply: '제 잘못이라고 한 적 없습니다. 저는 그냥… 어디서부터 어긋났는지 알고 싶을 뿐입니다.' }
  },
  'ij_break_2': {
    a: { label: '사람은 시스템이 아니다', trust: 1, reply: '압니다. 사람은 예측이 안 되죠. 그래서… 솔직히 무섭습니다.' },
    b: { label: '너도 힘들 거다', trust: 1, reply: '저는 괜찮습니다. 괜찮아야 하고요. 남은 사람 중에 시스템을 볼 줄 아는 건 저뿐이니까요.' }
  },
  'ij_break_3': {
    a: { label: '그건 결과론이다', trust: -1, reply: '결과론이죠. 그런데 ORACLE은 결과를 먼저 봅니다. 그게 사람과의 차이입니다.' },
    b: { label: '무슨 말이 하고 싶은 거냐', trust: 0, reply: '…아직 정리가 안 됐습니다. 정리되면, 그때 말씀드리겠습니다.' }
  },
  // ═══ 윤세진 연구 지연 불안 (sejin) ═══
  'sejin_anxiety_1': {
  ...
  // (act:3 응답은 제거됨 — 외부 간부진 저녁챗은 모두 act:[4]로 배치되어 _3_* 키가 매칭되지 않음)
  'weber_4_29-35': {
