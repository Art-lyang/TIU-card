...
var CARDS_BASE = [
  ...
  { id: "C-013", act: [2,3], priority: "상", img: "card_breach_horde", cctv: "card_breach_horde_cctv", msg: "ORACLE 긴급 통신: 봉쇄 구역 남측 경계에서 다수 생체 반응 감지. 즉각 대응 필요.", left: { label: "기지 방어 강화", fx: { c: -1, r: 0, t: 1, o: -1 }, g: -1 }, right: { label: "선제 출격", fx: { c: 2, r: -2, t: 0, o: 2 }, g: 1 } },
  ...
  // ── SPEC-001 감염체 마네킹 ──
  { id: "C-042", act: [3], priority: "상", img: "card_mannequin_sighting", cctv: "card_mannequin_sighting_cctv", tag: "spec-001", req: function(s,g,logs){ return !logs.includes("LOG-013") }, msg: "봉쇄 구역 내 상가 건물 정찰 중, 2층 창문 쪽에 인간 형태가 서 있는 것이 관측되었습니다.\n\n완전히 정지 상태. 호흡 감지 불가. 피부에 비정상적 광택.\n\n[ORACLE: SPEC-001 (감염체 마네킹) 추정. EV-Σ Phase 1. 접촉 금지.]", left: { label: "3m 밖에서 관측만", fx: { c: 0, r: 0, t: 1, o: 0 }, g: 0 }, right: { label: "열감지 스캐너로 확인", fx: { c: 1, r: -1, t: 0, o: 1 }, g: 1 } },
