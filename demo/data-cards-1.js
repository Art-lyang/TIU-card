...
var CARDS_BASE = [
  ...
  { id: "C-010", act: [2,3], priority: "상", tag: "spec-012", req: function(s,g,logs){ return !logs.includes("LOG-005") }, msg: "봉쇄 구역 내 SPEC-012 (Blood Pit) 활동 징후 감지. 붉은 점액질 웅덩이가 확장 중입니다.\n\n강도윤: \"밟는 순간 꼼짝 못 합니다. 벌레잡이 식물 같은 겁니다.\"", left: { label: "구역 격리만", fx: { c: -1, r: 0, t: 0, o: -1 }, g: -1 }, right: { label: "표본 원격 채취", fx: { c: 0, r: 0, t: 0, o: 1 }, g: 1 } },
  ...
  { id: "C-012", act: [2,3,4], priority: "하", msg: "강원도 내 민간 뉴스 — '야간 군사 차량 이동' 목격담 확산. 기지 보안 위험.", left: { label: "무시", fx: { c: -1, r: 0, t: 0, o: 0 }, g: 0 }, right: { label: "이동 경로 변경", fx: { c: 0, r: -1, t: 1, o: 1 }, g: 1 } },
  { id: "C-013", act: [2,3], priority: "상", alert: true, img: "card_breach_horde", cctv: "card_breach_horde_cctv", msg: "ORACLE 긴급 통신: 봉쇄 구역 남측 경계에서 다수 생체 반응 감지. 즉각 대응 필요.", left: { label: "기지 방어 강화", fx: { c: -1, r: 0, t: 1, o: -1 }, g: -1 }, right: { label: "선제 출격", fx: { c: 2, r: -2, t: 0, o: 2 }, g: 1 } },
  ...
  { id: "C-024", act: [2,3,4], priority: "하", req:function(s,g,logs){ return logs.indexOf("LOG-075")<0 && logs.indexOf("LOG-074-DONE")<0 }, msg: "야간 근무 요원 2명 사이에서 언쟁이 발생했습니다. 한 명이 교대 거부를 선언했습니다.", left: { label: "직접 중재", fx: { c: 0, r: 0, t: 2, o: -1 }, g: -1 }, right: { label: "강도윤에게 처리 위임", fx: { c: 0, r: 0, t: 1, o: 0 }, g: 0 } },
  { id: "C-025", act: [2,3,4], priority: "하", tag: "weather", img: "card_snow_blockade", msg: "폭설과 한파로 외부 보급로가 48시간 이상 차단될 전망입니다. 비상 물자 배분이 필요합니다.", left: { label: "배급제 시행", fx: { c: 0, r: 1, t: -1, o: 0 }, g: 0 }, right: { label: "대체 경로 탐색 (위험)", fx: { c: -1, r: 0, t: 0, o: 0 }, g: 0 } },
  ...
  { id: "C-031", act: [2,3], priority: "중", tag: "spec-011", req: function(s,g,logs){ return s.day >= 6 && logs.includes("LOG-004") }, cond: function(s,g,logs){ return logs.indexOf('LOG-SEJIN-DEAD')<0; }, msg: "윤세진 보고: 이변체 행동 패턴에 계절적 변화가 관측됩니다.\n\n\"Shell Talker의 활동 반경이 최근 7일 기준 40% 확대되었습니다.\"\n\n\"이건 단순한 이동이 아니에요. 뭔가를 찾고 있는 것처럼 보입니다.\"", left: { label: "윤세진 연구 지원", fx: { c: 0, r: -1, t: 1, o: -1 }, g: -1 }, right: { label: "ORACLE에 패턴 분석 의뢰", fx: { c: 0, r: 0, t: 0, o: 1 }, g: 2, log: 'LOG-SEJIN-DELAY-C031' } },
  // ── 추가 카드: 프로메테우스 ──
  { id: "C-032", act: [2,3], priority: "중", msg: "임재혁 보고: 프로메테우스가 사용하던 무선 주파수가 변경되었습니다.\n\n\"이전 주파수에 미끼 신호를 남겨뒀습니다. 우리가 감청하고 있다는 걸 알고 있을 수 있습니다.\"", left: { label: "새 주파수 추적", fx: { c: 0, r: -1, t: 0, o: -1 }, g: -2 }, right: { label: "ORACLE에 역추적 요청", fx: { c: 0, r: 0, t: 0, o: 1 }, g: 2 } },
  ...
  // ── SPEC-001 감염체 마네킹 ──
  { id: "C-042", act: [3], priority: "상", alert: true, img: "card_mannequin_sighting", cctv: "card_mannequin_sighting_cctv", tag: "spec-001", req: function(s,g,logs){ return !logs.includes("LOG-013") }, msg: "봉쇄 구역 내 상가 건물 정찰 중, 2층 창문 쪽에 인간 형태가 서 있는 것이 관측되었습니다.\n\n완전히 정지 상태. 호흡 감지 불가. 피부에 비정상적 광택.\n\n[ORACLE: SPEC-001 (감염체 마네킹) 추정. EV-Σ Phase 1. 접촉 금지.]", left: { label: "3m 밖에서 관측만", fx: { c: 0, r: 0, t: 1, o: 0 }, g: 0 }, right: { label: "열감지 스캐너로 확인", fx: { c: 1, r: -1, t: 0, o: 1 }, g: 1 } },
  { id: "C-043", act: [3], priority: "상", tag: "spec-001", msg: "긴급 보고 — 정찰조가 건물 내부에서 SPEC-001과 접촉 사고.\n\n\"마네킹인 줄 알았습니다. 장비 회수하려고 손을 뻗는 순간 — 0.3초 만에 목을 잡혔습니다.\"\n\n요원 1명 경상. 즉시 후퇴 완료.\n\n[ORACLE: 해당 건물 전체를 격리 구역으로 재지정합니다.]", left: { label: "건물 봉쇄 + 접근 금지", fx: { c: 1, r: -1, t: 1, o: 0 }, g: 0 }, right: { label: "ORACLE 원격 감시 설치", fx: { c: 1, r: -1, t: 0, o: 1 }, g: 2 } },
  // ── SPEC-003 Brood Drone ──
  { id: "C-044", act: [3], priority: "상", tag: "spec-003", req: function(s,g,logs){ return !logs.includes("LOG-014") }, msg: "봉쇄선 남측에서 소형 개체 다수가 이동 중입니다.\n\n강도윤: \"크기는 사람의 절반 정도. 외골격. 단안. 최소 20체가 편대 이동 중입니다.\"\n\n[ORACLE: SPEC-003 (Brood Drone) 확인. 하나는 약합니다. 문제는 하나인 적이 없다는 것입니다.]", left: { label: "봉쇄선 방어 태세", fx: { c: 1, r: -1, t: 0, o: 0 }, g: 0 }, right: { label: "군체 통신 교란 장비 가동", fx: { c: 2, r: -2, t: 0, o: 1 }, g: 1 } },
  { id: "C-045", act: [3], priority: "상", tag: "spec-003", msg: "Brood Drone 집단이 기지 외곽 500m까지 접근했습니다.\n\n약 40체. 이전보다 조직적입니다. 대형을 갖추고 있습니다.\n\n강도윤: \"누군가가 이것들을 지휘하고 있습니다. 드론끼리는 이런 전술을 못 합니다.\"\n\n[ORACLE: 상위 지휘 개체 존재 가능성. 경계 강화 권고.]", left: { label: "방어선 후퇴 + 집결", fx: { c: -1, r: 0, t: 1, o: 0 }, g: 0 }, right: { label: "지휘 개체 색출 작전", fx: { c: 1, r: -2, t: 0, o: 1 }, g: 1 } },
  // ── SPEC-008 Spore Phantom ──
  { id: "C-046", act: [3], priority: "중", tag: "spec-008", req: function(s,g,logs){ return !logs.includes("LOG-015") }, msg: "봉쇄 구역 내 안개가 비정상적으로 짙어지고 있습니다.\n\n정찰조 보고: \"안개 속에서 사람처럼 걸어오는 형체가 보입니다. 조명을 비추면 흩어졌다가 — 더 가까이에서 다시 나타납니다.\"\n\n[ORACLE: SPEC-008 (Spore Phantom) 추정. 포자 집합체. 실체 불명. 흡입 위험.]", left: { label: "정찰조 즉시 철수", fx: { c: -1, r: 0, t: 1, o: 0 }, g: 0 }, right: { label: "방독면 착용 후 관측", fx: { c: 0, r: -1, t: 0, o: 1 }, g: 1 } },
  { id: "C-047", act: [3], priority: "중", tag: "spec-008", msg: "윤세진 긴급 보고: 기지 인근 포자 농도가 기준치의 5배를 초과했습니다.\n\n\"Spore Phantom이 접근하고 있는 것 같습니다. 환기 시스템을 밀폐 모드로 전환해야 합니다.\"\n\n[ORACLE: 포자 흡입 시 즉시 감염. 외부 활동 제한 권고.]", left: { label: "기지 밀폐 + 외부 활동 중단", fx: { c: -2, r: -1, t: 1, o: 0 }, g: 0 }, right: { label: "포자 밀도 저감 작업 (소각)", fx: { c: 0, r: -2, t: 0, o: 1 }, g: 1 } },
  // ── 추가 카드: 기지 운영 + 탈북자 ──
  ...
  { id: "C-051", act: [3], priority: "상", msg: "봉쇄선 북측에서 신원미상의 인물이 양손을 든 채 접근하고 있습니다.\n\n무장 없음. 극도로 지친 상태. 반복적으로 무언가를 외치고 있습니다.\n\n강도윤: \"항복 의사로 보입니다. 어떻게 합니까?\"", left: { label: "직접 확인한다", fx: { c: 0, r: 0, t: 1, o: -1 }, g: -1 }, right: { label: "ORACLE에 보고", fx: { c: 0, r: 0, t: 0, o: 1 }, g: 2 } },
];
