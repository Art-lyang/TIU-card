...
var CARDS_RELIEF = [
  ...
  { id:"A3-SUPPLY-03", act:[2,3,4], priority:"상", forceFlow:true, tag:"relief-bridge", bg:"supply",
    req:function(s,g,logs){ return s.day>=8 && (s.r<=30 || s.t<=30); },
    ...
    left:{ label:"보급·인력을 균형 배분한다", fx:{c:0,r:3,t:3,o:1}, floor:{r:35,t:35}, floorCriticalOnly:true, g:1, trust:2, log:"LOG-RELIEF-SUPPLY" },
    right:{ label:"당장 급한 쪽에 몰아준다", fx:{c:1,r:3,t:2,o:0}, floor:{r:33,t:30}, floorCriticalOnly:true, g:0, trust:1, log:"LOG-RELIEF-SUPPLY" } }
