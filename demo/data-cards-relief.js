...
var CARDS_RELIEF = [
  ...
  { id:"A2-SUPPLY-01", act:[2], priority:"상", once:true, bg:"supply",
    req:function(s,g,logs){ return s.day>=9 && g>=10 && s.r<=40 && logs.indexOf('ONCE-A2-SUPPLY-01')<0; },
  ...
  { id:"A2-MORALE-01", act:[2], priority:"상", once:true, bg:"supply",
    req:function(s,g,logs){ return s.day>=10 && g>=10 && s.t<=45 && logs.indexOf('ONCE-A2-MORALE-01')<0; },
  ...
  { id:"A3-SUPPLY-01", act:[3], priority:"상", once:true, bg:"supply",
    req:function(s,g,logs){ return s.day>=16 && g>=0 && logs.indexOf('ONCE-A3-SUPPLY-01')<0; },
  ...
  { id:"A3-SUPPLY-02", act:[3], priority:"상", bg:"supply",
    req:function(s,g,logs){ return s.day>=20 && s.r<=45 && g>=0; },
  ...
  { id:"A4-SUPPLY-01", act:[4], priority:"상", once:true, bg:"supply",
    req:function(s,g,logs){ return s.r<=45 && g>=0 && logs.indexOf('ONCE-A4-SUPPLY-01')<0; },
  ...
  { id:"A3-MORALE-01", act:[3], priority:"중", once:true, bg:"supply",
    req:function(s,g,logs){ return s.day>=20 && g>=0 && s.t<=65 && logs.indexOf('ONCE-A3-MORALE-01')<0; },
  ...
  { id:"A3-MORALE-02", act:[3], priority:"중", bg:"supply",
    req:function(s,g,logs){ return s.day>=22 && s.t<=45 && g>=0; },
  ...
  { id:"A4-MORALE-01", act:[4], priority:"중", once:true, bg:"supply",
    req:function(s,g,logs){ return s.day>=30 && g>=0 && s.t<=60 && logs.indexOf('ONCE-A4-MORALE-01')<0; },
