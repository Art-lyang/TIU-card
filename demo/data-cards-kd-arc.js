...
(function(){
  ...
  var C = [
    // ── 추모: 남겨진 작전 일지 ──
    { id:"C-KD-MEMORIAL", act:[3,4], priority:"중", once:true, bg:"base", img:"card_kd_memorial", flashImg:"card_kd_memorial",
    ...
    // ── 여파: 전술지휘 공백 ──
    { id:"C-KD-VACUUM", act:[3,4], priority:"상", once:true, alert:true, bg:"base", img:"card_kd_vacuum",
    ...
    { id:"C-KD-VACUUM-B", act:[3,4], priority:"상", once:true, alert:true, bg:"base", img:"card_kd_vacuum",
    ...
    // ── 여파: 팀이 그를 지우지 않는다 ──
    { id:"C-KD-ECHO", act:[3,4], priority:"하", once:true, bg:"forest", img:"card_kd_echo",
      req:function(s,g,logs){ return lost(logs); },
