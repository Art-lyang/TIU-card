...
window.TS_I18N.mergeContent('en', {
  cards: {
    ...
    "A4-SUPPLY-01": { msg:"[ORACLE: Final-phase support protocol. Priority resupply airdropped to loyal-operating bases.]\n\nSeo Ha-eun: \"HQ won't abandon us at the very end. This buys a few more days.\"", leftLabel:"Secure the emergency supplies", rightLabel:"Release some to lift morale" },
    ...
    "A3-MORALE-01": { msg:"The agents' accumulated-fatigue reports reached HQ.\n\n[ORACLE: Assigning two relief personnel, priority given to compliant-operating bases.]\n\nSeo Ha-eun: \"First time a staffing request cleared this fast. It means they trust us up top.\"", leftLabel:"Take the relief personnel", rightLabel:"Spend it on existing staff's conditions" },
    "A3-MORALE-02": { msg:"Yun Se-jin compiles the agents' grievances: meals, rest space, medical support.\n\n[ORACLE: Item-by-item improvements relayed to HQ. Three approved immediately.]\n\nYun Se-jin: \"As long as grievances go up and answers come back down, people hold.\"", leftLabel:"Apply the improvements on-site", rightLabel:"Make the reporting channel permanent" },
